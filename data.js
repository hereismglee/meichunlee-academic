...
const INFO = {
  ...
  bio_en: `I am an Associate Research Fellow at the Institute of Ethnology, Academia Sinica, Taiwan. As a digital anthropologist, my research sits at the intersection of digital technology, politics, and anthropology — with a core focus on the dynamic relationship between technology and democracy. I study civic technology, hacker culture, data politics, disinformation, and posthuman warfare, drawing on long-term ethnographic fieldwork in Taiwan and East Asia.`,
  bio_zh: `我是中央研究院民族學研究所的副研究員，研究領域為數位人類學，聚焦於科技與民主的動態關係。研究主題包括公民科技、黑客文化、資料政治、假訊息與後人類戰爭，以台灣與東亞為主要田野場域。`,
