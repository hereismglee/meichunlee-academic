...
const INFO = {
  ...
  title_zh:     "數位人類學家",
  position_en:  "Associate Research Fellow",
  position_zh:  "副研究員",
  institution_en: "Institute of Ethnology, Academia Sinica",
  institution_zh: "中央研究院民族學研究所",
  bio_en: `I am a digital anthropologist and Associate Research Fellow at the Institute of Ethnology, Academia Sinica, Taiwan. My research examines the intersections of technology and politics, with a focus on civic technology, hacker culture, data politics, disinformation, and posthuman warfare, primarily in Taiwan and East Asia. I am the author of The “Nobody” Movement and have published widely in leading international journals in anthropology and science and technology studies (STS). My work has received the Wang Yu-Fong Memorial Award for Young Scholars and the Ta-You Wu Memorial Award from Taiwan’s National Science and Technology Council (NSTC). More recently, I founded the Cyborg Resilience Co-lab (CRC), which brings together research, technical experimentation, and public engagement to explore emerging issues at the intersections of technology, geopolitics, and civil society.`,
  bio_zh: `我是數位人類學家，現職為中研院民族學研究所副研究員。我關注科技與政治的交織，研究涵蓋公民科技、黑客文化、資料政治、假訊息與後人類戰爭，並以台灣及東亞為主要田野。著有《「沒有人」的運動》，並於人類學與科技與社會研究重要國際期刊發表多篇論文。曾獲王玉豐年輕學者論文紀念獎、國科會吳大猷先生紀念獎。近年亦創辦 CRC 賽伯格韌性實驗室，透過研究、技術實作與公共參與，探索科技、地緣政治與公民社會之間的新興議題。`,
  photo:        "images/profile.png",
  cv_url:       "images/cv.pdf",        // ← put your CV filename here
  email:        "mclee@as.edu.tw",
